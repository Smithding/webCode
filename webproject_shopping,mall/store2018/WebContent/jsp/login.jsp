...
<div class="row"> 
	...
	<div class="col-md-5">
				...
				<font>会员登录</font>USER LOGIN  <div style="color: red">${msg }</div><br>
...
<form class="form-horizontal" action="${pageContext.request.contextPath }/demo" method="post">
 ...
 <div class="form-group">
    ...
    <div class="col-sm-6">
      <input type="text" class="form-control" id="username" placeholder="请输入用户名" name="username" value="${cookiezz.aount.value }">
    </div>
  </div>
   <div class="form-group">
   ...
   <div class="form-group">
    <div class="col-sm-offset-2 col-sm-10">
      <div class="checkbox">
        <label>
          <input type="checkbox" name="with"> 自动登录
        </label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <label>
          <input type="checkbox" name="aount"> 记住用户名
        </label>
      </div>
    </div>
  </div>
