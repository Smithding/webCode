		...
		<div class="container">
			<div class="row">
				...
				<div style="border: 1px solid #e4e4e4;width:930px;margin-bottom:10px;margin:0 auto;padding:10px;margin-bottom:10px;">
					...
					<a href="${pageContext.request.contextPath}/indexServlet?method=index">首页&nbsp;&nbsp;&gt;</a>
					<a href="${pageContext.request.contextPath}/productServlet?method=findByPage&curPage=1&cid=${ p.cid}">手机数码&nbsp;&nbsp;&gt;</a>
					<a>${p.pname}</a>
				</div>
				...
				<div style="margin:0 auto;width:950px;">
					...
					<div class="col-md-6">
						...
						<div style="margin:10px 0 10px 0;">亿家价: <strong style="color:#ef0101;">￥：${p.shop_price}元/份</strong> 参 考 价： <del>￥${p.market_price}元/份</del>
						</div>
