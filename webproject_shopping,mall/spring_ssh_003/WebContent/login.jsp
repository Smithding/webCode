...
<script type="text/javascript">
	...
	function registSub(){
		document.getElementById("form1").action="${ pageContext.request.contextPath }/regist.jsp";
		document.getElementById("form1").submit();
	}
</script>
...
<BODY>
<FORM id=form1 action="${ pageContext.request.contextPath }/user_login.action" name=form1  method=post target="_parent">
            ...
            <TABLE cellSpacing=0 cellPadding=2 border=0>
              ...
              <TR>
                ...
                <TD style="HEIGHT: 28px" width=370><SPAN 
                  ...
                  style="FONT-WEIGHT: bold;COLOR: white"><s:property value="msg"/></SPAN></TD></TR>
              <TR>
              ...
              <TR>
                ...
                <TD><INPUT id=btn 
                  style="BORDER-TOP-WIDTH: 0px; BORDER-LEFT-WIDTH: 0px; BORDER-BOTTOM-WIDTH: 0px; BORDER-RIGHT-WIDTH: 0px" 
                  onclick='registSub()' 
                  type=image src="images/regist_button.gif" name=btn> 
              </TD></TR>
