						...
						<TABLE cellSpacing=0 cellPadding=5  border=0>
							<tr>
								...
								<select name="customer.cust_id" >
									<option value=""><s:property value="customer.cust_name"/></option>
							...
							<TR>
								...
								<td>联系人性别：</td>
								<td>
								<input type="radio" value="男" name="lkm_gender" <s:if test='lkm_gender=="男"'>checked</s:if>>男
								
								<input type="radio" value="女" name="lkm_gender" <s:if test='lkm_gender=="女"'>checked</s:if>>女
								</td>
							</TR>
							<TR>
								<td>联系人办公电话 ：</td>
